...
async def rename(ctx, arg):
	...
	await client.send_message(client.get_channel('496104544040910860'), VOICE_CHANNELS.keys())	
	if ctx.message.author.voice.voice_channel.id in VOICE_CHANNELS.keys():
